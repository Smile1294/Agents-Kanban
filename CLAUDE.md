...
| What does the harness do today, what is missing, and what is next (browser self-testing, history, image annotation, research on other harnesses)? | [docs/HARNESS-REVIEW.md](docs/HARNESS-REVIEW.md) — phases 1–3 are BUILT; §6 is the ranked roadmap |
