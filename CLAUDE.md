...
| What does the harness do today, what is missing, and what is next (browser self-testing, history, image annotation, research on other harnesses)? | [docs/HARNESS-REVIEW.md](docs/HARNESS-REVIEW.md) — two rounds BUILT (§3, §4); §5a is what people switch tools for; §6 is the ranked roadmap |
